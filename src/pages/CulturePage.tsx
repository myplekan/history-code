    ...
    <main className="pt-[102px] px-10">
      ...
      <div className="flex flex-wrap gap-16 justify-between pb-44">
        ...
        <HistoryCultureCard
          ...
          description={
            "Розвиток сучасної української культури відбувається в різних напрямках, включаючи літературу, кіно, музику, театр та мистецтво. Українські художники, музиканти та кінематографісти активно працюють над творенням нових творів та висвітленням сучасних соціокультурних та політичних реалій."
          }
        />
      </div>
