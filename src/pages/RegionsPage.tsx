...
import { RegionHover } from "../components/RegionHover/RegionHover";
  ...
  return (
    <main className="pt-24 pb-[66px]">
      ...
      <div className="relative flex justify-end">
        <div className="absolute top-2/4 -translate-y-1/2">
          <AnimatePrint />
        </div>

        <svg
          className="h-[662px] w-[1000px] px-10"
          id="Ukraine"
        ...
        >
          ...
          <g id="ukraineMap">
            <image
              href={process.env.PUBLIC_URL + "/images/svg/border.svg"}
              width="655"
              height="500"
              x="-21"
              y="-45"
            ...
            <Link
              id="Cherkasy"
              target="_new"
              to="https://en.wikipedia.org/wiki/Cherkasy_Oblast"
            ...
            >
              <path
                ...
                d="m 291.67191,101.88242 -0.19,1.41 0.39,0.51 0,0.91 1.67,1.51 0.19,1.81 -1.35,1.82 -1.93,0.9 -1.55,-1 -0.84,0.1 -0.32,0.4 -0.13,1.51 0.39,0.3 0.13,1.21 -0.52,0.9 0,1.01 0.39,1.61 -0.9,1 -1.03,-0.4 -0.97,-1.51 -0.77,-2.21 -0.33,-2.51 -1.03,0.1 -0.9,-0.81 -0.58,-0.1 -0.84,-2.52 -1.03,0 -0.51,-0.4 -0.45,-2.02 -1.29,-0.2 -1.29,0.4 -0.64,0.41 -0.26,0.7 -0.71,0.1 -0.26,-0.9 1.1,-2.73 0,-1.01 0.51,-0.81 1.03,-1.01 0.9,0.2 0.33,-0.599997 -0.26,-0.61 -1.35,-0.91 -0.07,-0.51 0.32,-0.2 2.71,-0.2 2.38,0.4 3.03,3.239997 1.55,-0.91 2.9,0 0.64,-0.509997 0.65,-1.31 1.16,-0.41 1.87,0.61 0.58,0.61 0,1.409997 -0.65,0.41 -0.71,-0.2 -0.84,0.4 z"
              ></path>
            </a>
            <a
              id="Kirovohrad"
            ...
            <g className="cityName cityTernopil">
              <RegionHover x={110} y={165} width={125} region={'Тернопільська'} />
            ...
            <g className="cityName cityMykolaiv">
              <RegionHover x={310} y={265} width={120} region={'Миколаївська'} />
            ...
            <g className="cityName cityIvano-Frankivsk">
              <RegionHover x={80} y={200} width={155} region={'Івано-Франківська'} />
            ...
            <g className="cityName cityKropyvnytskyi">
              <RegionHover x={290} y={210} width={135} region={'Кіровоградська'} />
      ...
      <h2 className="font-rutenia text-[52px] mb-4 pl-10">Карта України</h2>

      <div className="flex items-center gap-4 text-2xl mb-8 text-gray-100 pl-10">
        <img
          width={33}
        ...
        <span className="max-w-[600px]">
          Загальна площа території України становить 603 628 км², тобто 5,7 %
          території Європи. Адмiнiстративно-територiальний устрій України
          складається з Автономної Республіки Крим та 24 областей.
        </span>
      </div>

      {region && (
        <RegionModal regionName={region} setRegion={setRegion} />
      )}
    </main>
  );
};
